...
// Wrap the main ReferralTracking component in a Suspense boundary.
// This wrapper ensures that any internal uses of client hooks that suspend (e.g. useSearchParams)
// have the proper Suspense context.
